...
define dso_local void @CAT_execution() local_unnamed_addr #0 {
  ...
  call void @CAT_sub(i8* noundef %7, i8* noundef inttoptr (i64 8 to i8*), i8* noundef inttoptr (i64 5 to i8*)) #4
  call void @CAT_add(i8* noundef %7, i8* noundef inttoptr (i64 8 to i8*), i8* noundef %7) #4
