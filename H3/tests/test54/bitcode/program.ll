...
16:                                               ; preds = %8, %16
  ...
  br i1 %25, label %29, label %16, !llvm.loop !3
...
29:                                               ; preds = %16, %40
  %30 = phi i32 [ %43, %40 ], [ 0, %16 ]
  %31 = phi i32 [ %42, %40 ], [ 0, %16 ]
  %32 = phi i8* [ %41, %40 ], [ %23, %16 ]
...
45:                                               ; preds = %29, %56
  %46 = phi i32 [ %59, %56 ], [ 0, %29 ]
  %47 = phi i32 [ %58, %56 ], [ 0, %29 ]
  %48 = phi i8* [ %57, %56 ], [ %38, %29 ]
...
56:                                               ; preds = %61, %45
  %57 = phi i8* [ %54, %45 ], [ %68, %61 ]
  %58 = add nuw i32 %47, 1
  %59 = add i32 %46, 2
  %60 = icmp eq i32 %58, %33
  br i1 %60, label %40, label %45, !llvm.loop !8

61:                                               ; preds = %45, %61
  %62 = phi i32 [ %69, %61 ], [ 0, %45 ]
  %63 = phi i8* [ %68, %61 ], [ %54, %45 ]
  ...
  br i1 %70, label %56, label %61, !llvm.loop !9

71:                                               ; preds = %26
  %72 = call i8* @CAT_new(i64 noundef 52) #4
  call void @CAT_add(i8* noundef %72, i8* noundef %72, i8* noundef %72) #4
  call void @CAT_sub(i8* noundef %72, i8* noundef %72, i8* noundef %72) #4
  call void @CAT_set(i8* noundef %72, i64 noundef 42) #4
  %73 = call i64 @CAT_variables() #4
  %74 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([21 x i8], [21 x i8]* @.str.5, i64 0, i64 0), i64 noundef %73)
  %75 = call i64 @CAT_cost() #4
  %76 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([16 x i8], [16 x i8]* @.str.6, i64 0, i64 0), i64 noundef %75)
  ret i32 0
}
