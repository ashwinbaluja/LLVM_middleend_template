...
17:                                               ; preds = %12, %17
  ...
  br i1 %22, label %.preheader3, label %17, !llvm.loop !3
...
.preheader3:                                      ; preds = %17, %.loopexit2
  %26 = phi i32 [ %33, %.loopexit2 ], [ 0, %17 ]
  %27 = phi i32 [ %32, %.loopexit2 ], [ 0, %17 ]
  ...
  %31 = icmp eq i32 %27, 0
  br i1 %31, label %.loopexit2, label %.preheader1
...
.preheader1:                                      ; preds = %.preheader3, %.loopexit
  %35 = phi i32 [ %42, %.loopexit ], [ 0, %.preheader3 ]
  %36 = phi i32 [ %41, %.loopexit ], [ 0, %.preheader3 ]
...
.loopexit:                                        ; preds = %.preheader, %.preheader1
  ...
  br i1 %43, label %.loopexit2, label %.preheader1, !llvm.loop !8

.preheader:                                       ; preds = %.preheader1, %.preheader
  %44 = phi i32 [ %47, %.preheader ], [ 0, %.preheader1 ]
  ...
  br i1 %48, label %.loopexit, label %.preheader, !llvm.loop !9
}
