...
define dso_local i32 @main(i32 noundef %0, i8** nocapture noundef readnone %1) local_unnamed_addr #0 {
  ...
  %4 = call i8* @CAT_new(i64 noundef 9) #3
  ...
  %8 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i64 noundef %7)
  %9 = call i8* @CAT_new(i64 noundef 52) #3
  call void @CAT_add(i8* noundef %9, i8* noundef %9, i8* noundef %9) #3
  call void @CAT_sub(i8* noundef %9, i8* noundef %9, i8* noundef %9) #3
