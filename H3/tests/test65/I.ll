...
11:                                               ; preds = %2, %11
  ...
  %13 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i64 noundef 0)
  call void @CAT_set(i8* %5, i64 42)
  %14 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i64 noundef 42)
  call void @CAT_set(i8* %3, i64 80)
  call void @CAT_set(i8* %4, i64 4)
  %15 = call i8* @CAT_new(i64 noundef 1) #4
  %16 = call i32 @rand() #5
  %17 = sext i32 %16 to i64
  call void @CAT_set(i8* noundef %5, i64 noundef %17) #4
  %18 = call i64 @CAT_get(i8* noundef %5) #4
  %19 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), i64 noundef 1, i64 noundef %18)
  %20 = add nuw nsw i32 %12, 1
  %21 = icmp eq i32 %20, 10
  br i1 %21, label %6, label %11, !llvm.loop !3
}
