...
15:                                               ; preds = %2, %15
  %16 = phi i8* [ %26, %15 ], [ %5, %2 ]
  %17 = phi i32 [ %27, %15 ], [ 0, %2 ]
  %18 = phi i32 [ %21, %15 ], [ %0, %2 ]
  %19 = icmp sgt i32 %18, 500
  %20 = sext i1 %19 to i32
  %21 = add nsw i32 %18, %20
  %22 = call i64 @CAT_get(i8* noundef %16) #4
  ...
  %24 = call i64 @CAT_get(i8* noundef %16) #4
  %25 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i64 noundef %24)
  ...
  br i1 %30, label %15, label %9, !llvm.loop !7
}
