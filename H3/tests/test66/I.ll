...
16:                                               ; preds = %12
  %17 = call i8* @CAT_new(i64 noundef 1) #4
  br label %18

18:                                               ; preds = %16, %12
  %19 = call i32 @rand() #5
  %20 = sext i32 %19 to i64
  call void @CAT_set(i8* noundef %5, i64 noundef %20) #4
  %21 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), i64 noundef 1, i64 noundef 0)
  %22 = add nuw nsw i32 %13, 1
  %23 = icmp eq i32 %22, 10
  br i1 %23, label %7, label %12, !llvm.loop !3
}
