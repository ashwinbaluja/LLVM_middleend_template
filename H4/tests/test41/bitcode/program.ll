...
define dso_local i8* @CAT_create_aaaaaa_aaaaa(i32 noundef %0) local_unnamed_addr #0 {
  %2 = add nsw i32 %0, 1
  %3 = sext i32 %2 to i64
...
define dso_local i32 @main(i32 noundef %0, i8** nocapture noundef readnone %1) local_unnamed_addr #2 {
  ...
  %6 = call i8* @CAT_new(i64 noundef 52) #4
  call void @CAT_add(i8* noundef %6, i8* noundef %6, i8* noundef %6) #4
  call void @CAT_sub(i8* noundef %6, i8* noundef %6, i8* noundef %6) #4
  call void @CAT_set(i8* noundef %6, i64 noundef 42) #4
