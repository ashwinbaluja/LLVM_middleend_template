...
14:                                               ; preds = %13, %2
  %15 = call i64 @CAT_get(i8* noundef %4) #4
  %16 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i64 0, i64 0), i64 noundef %15)
  %17 = load i8*, i8** %3, align 8, !tbaa !3
  %18 = call i64 @CAT_get(i8* noundef %17) #4
