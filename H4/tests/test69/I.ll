...
define dso_local void @CAT_execution(i8* noundef %0) local_unnamed_addr #0 {
  ...
  call void @CAT_sub(i8* noundef %0, i8* noundef %0, i8* noundef %0) #3
  %6 = call i64 @CAT_get(i8* noundef %0) #3
  %7 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), i64 noundef %6)
  call void @CAT_set(i8* noundef %0, i64 noundef 42) #3
  %8 = call i64 @CAT_get(i8* noundef %0) #3
  %9 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), i64 noundef %8)
  ret void
}
...
define dso_local i32 @main(i32 noundef %0, i8** nocapture noundef readnone %1) local_unnamed_addr #0 {
  ...
  call void @CAT_execution(i8* noundef %3)
  %4 = call i64 @CAT_variables() #3
  %5 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([21 x i8], [21 x i8]* @.str.2, i64 0, i64 0), i64 noundef %4)
  %6 = call i64 @CAT_cost() #3
  %7 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([16 x i8], [16 x i8]* @.str.3, i64 0, i64 0), i64 noundef %6)
  ret i32 0
}
