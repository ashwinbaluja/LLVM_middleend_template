...
.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  %14 = phi i8* [ %20, %.preheader ], [ %5, %.preheader.preheader ]
  %15 = phi i32 [ %21, %.preheader ], [ 0, %.preheader.preheader ]
  %16 = call i64 @CAT_get(i8* noundef %14) #3
  ...
  %20 = call i8* @CAT_new(i64 noundef 1) #3
  %21 = add nuw nsw i32 %15, 1
  %22 = icmp eq i32 %21, %7
  br i1 %22, label %.loopexit.loopexit, label %.preheader, !llvm.loop !3
}
