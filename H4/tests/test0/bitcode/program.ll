...
16:                                               ; preds = %0
  call void @CAT_add(i8* noundef %7, i8* noundef %7, i8* noundef %1) #5
  call void @CAT_sub(i8* noundef %7, i8* noundef %7, i8* noundef %4) #5
  call void @CAT_set(i8* noundef %4, i64 noundef 41) #5
  call void @CAT_set(i8* noundef %1, i64 noundef 39) #5
  br label %17

17:                                               ; preds = %16, %0
  call void @CAT_add(i8* noundef %7, i8* noundef %7, i8* noundef %4) #5
  call void @CAT_add(i8* noundef %7, i8* noundef %7, i8* noundef %1) #5
  %18 = call i64 @CAT_get(i8* noundef %7) #5
  %19 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), i64 noundef %18)
  call void @CAT_destroy(i8* noundef %1) #5
  call void @CAT_destroy(i8* noundef %4) #5
  call void @CAT_destroy(i8* noundef %7) #5
  ret void
}
