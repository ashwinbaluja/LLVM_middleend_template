...
define dso_local void @CAT_execution(i32 %0, i8* noundef %1, i32 %2) local_unnamed_addr #0 {
  call void @CAT_set(i8* noundef %1, i64 noundef 44) #4
  ret void
}
...
define dso_local i32 @main(i32 noundef %0, i8** nocapture noundef readnone %1) local_unnamed_addr #2 {
  ...
  call void @CAT_execution(i32 undef, i8* noundef %3, i32 undef)
