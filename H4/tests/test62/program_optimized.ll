...
define dso_local i32 @escape_reason(i8* noundef readnone %0, i8* noundef readnone %1) local_unnamed_addr #0 {
  %3 = icmp eq i8* %0, %1
  %4 = zext i1 %3 to i32
  ret i32 %4
}
...
define dso_local i32 @main(i32 noundef %0, i8** nocapture noundef readnone %1) local_unnamed_addr #1 {
  ...
  %7 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0), i32 noundef %5, i64 noundef 42, i64 noundef %6)
