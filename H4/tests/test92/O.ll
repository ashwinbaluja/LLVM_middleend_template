...
define dso_local i64 @generic_C_function(i8* noundef %0) local_unnamed_addr #0 {
  ...
  %4 = icmp sgt i64 %3, 10
  %spec.select = select i1 %4, i64 204, i64 0
  ret i64 %spec.select
}
...
define dso_local i32 @main(i32 noundef %0, i8** nocapture noundef readnone %1) local_unnamed_addr #0 {
  ...
  %5 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i64 noundef 204)
