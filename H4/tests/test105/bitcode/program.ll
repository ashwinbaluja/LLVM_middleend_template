...
define dso_local i8** @function_that_complicates_everything(i32 noundef %0, i8** noundef readnone %1, i8** noundef readnone %2) local_unnamed_addr #0 {
  %4 = icmp sgt i32 %0, 5
...
define dso_local i32 @main(i32 noundef %0, i8** nocapture noundef readnone %1) local_unnamed_addr #1 {
  ...
  %7 = call i64 @CAT_get(i8* noundef %6) #4
  %8 = call i64 @CAT_get(i8* noundef %3) #4
  %9 = call i64 @CAT_get(i8* noundef %4) #4
