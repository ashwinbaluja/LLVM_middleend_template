...
.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  %11 = phi i32 [ %18, %.preheader ], [ 0, %.preheader.preheader ]
  %12 = call i64 @CAT_get(i8* noundef %3) #3
  %13 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i64 noundef %12)
  ...
  call void @CAT_add(i8* noundef %15, i8* noundef %3, i8* noundef %4) #3
  %16 = call i64 @CAT_get(i8* noundef %15) #3
  %17 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i64 0, i64 0), i64 noundef %16)
