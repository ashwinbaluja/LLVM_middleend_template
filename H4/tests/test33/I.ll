...
define dso_local void @CAT_execution(i8* noundef %0) local_unnamed_addr #0 {
  %2 = call i8* @CAT_new(i64 noundef 8) #3
  call void @CAT_set(i8* %0, i64 16)
  %3 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), i64 noundef 8)
  %4 = call i8* @CAT_new(i64 noundef 0) #3
  call void @CAT_add(i8* noundef %4, i8* noundef %0, i8* noundef %2) #3
  %5 = call i64 @CAT_get(i8* noundef %4) #3
  %6 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i64 0, i64 0), i64 noundef %5)
  ret void
}
...
define dso_local i32 @main(i32 noundef %0, i8** nocapture noundef readnone %1) local_unnamed_addr #0 {
  ...
  call void @CAT_set(i8* %3, i64 16)
  %5 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), i64 noundef 8) #4
  %6 = call i8* @CAT_new(i64 noundef 0) #3
  call void @CAT_set(i8* %6, i64 24)
  %7 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i64 0, i64 0), i64 noundef 24) #4
  %8 = call i8* @CAT_new(i64 noundef 52) #3
  ...
  %10 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([21 x i8], [21 x i8]* @.str.2, i64 0, i64 0), i64 noundef %9)
  %11 = call i64 @CAT_cost() #3
  %12 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([16 x i8], [16 x i8]* @.str.3, i64 0, i64 0), i64 noundef %11)
  ret i32 0
}
