...
define dso_local i8** @function_that_complicates_everything(i32 noundef %0, i8** noundef readonly %1, i8** noundef readonly %2) local_unnamed_addr #0 {
  %4 = load i8*, i8** %1, align 8, !tbaa !3
  call void @CAT_set(i8* noundef %4, i64 noundef 42) #3
  %5 = load i8*, i8** %2, align 8, !tbaa !3
  call void @CAT_set(i8* noundef %5, i64 noundef 43) #3
  %6 = icmp sgt i32 %0, 5
...
define dso_local i32 @main(i32 noundef %0, i8** nocapture noundef readnone %1) local_unnamed_addr #0 {
  ...
  %4 = call i8* @CAT_new(i64 noundef 7) #3
  call void @CAT_set(i8* noundef %3, i64 noundef 42) #3
  call void @CAT_set(i8* noundef %4, i64 noundef 43) #3
  %5 = icmp sgt i32 %0, 5
  ...
  %10 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i64 0, i64 0), i64 noundef %7, i64 noundef %8, i64 noundef %9)
  %11 = call i8* @CAT_new(i64 noundef 52) #3
  call void @CAT_add(i8* noundef %11, i8* noundef %11, i8* noundef %11) #3
  call void @CAT_sub(i8* noundef %11, i8* noundef %11, i8* noundef %11) #3
