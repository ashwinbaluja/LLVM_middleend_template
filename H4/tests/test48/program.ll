...
8:                                                ; preds = %3
  ...
  call void @CAT_add(i8* noundef %1, i8* noundef %9, i8* noundef %9) #3
  br label %10
...
10:                                               ; preds = %8, %3
  ...
  %14 = call i64 @CAT_get(i8* noundef %1) #3
  %15 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([20 x i8], [20 x i8]* @.str.2, i64 0, i64 0), i64 noundef %14)
  %16 = icmp sgt i32 %2, 0
  br i1 %16, label %17, label %20

17:                                               ; preds = %10
  %18 = call i64 @CAT_get(i8* noundef %11) #3
  %19 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i64 0, i64 0), i64 noundef %18)
  br label %20
